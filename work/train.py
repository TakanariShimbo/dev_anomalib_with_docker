...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument("--config", type=str, default="./myenv/lib/python3.9/site-packages/anomalib/models/padim/config.yaml", required=False, help="Path to a model config file")
